...
import type {Handler, HttpMethod, RouteCommon, RouteImplementation} from './types.ts';
import {RouterError} from "./errors";
import type {Context} from "./context.ts";

interface BaseRouteResult extends RouteCommon {
    params?: Record<string, any>;
}

export type RouteResult = (BaseRouteResult & { handler: Handler } | BaseRouteResult & {
